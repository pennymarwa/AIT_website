					...
					switch ( $obj->type ) :
						...
						case 'file-upload' :
							...
							<tr valign="top">
								...
								<td><a href="<?php esc_attr_e( $obj->value ); ?>" target="_blank"><?php echo esc_html( $obj->value ); ?></a></td>
							</tr>
	                    	<?php
							break;
						...
						case 'html' :
							...
							<tr valign="top">
								<th scope="row"><label for="field[<?php echo $obj->id; ?>]"><?php echo stripslashes( $obj->name ); ?></label></th>
								<td><?php echo wpautop( esc_html( $obj->value ) ); ?></td>
							</tr>
	                    	<?php
							break;
						...
						default :
							...
							<tr valign="top">
								<th scope="row"><label for="field[<?php echo $obj->id; ?>]"><?php echo stripslashes( $obj->name ); ?></label></th>
								<td><?php echo esc_html( $obj->value ); ?></td>
							</tr>
                        	<?php
							break;
