	...
	*/
	function __construct()
	{
		...
		{		
			...
			add_action('admin_init', array($this, 'addthick')); // Thickbox - should be phased out
	...
	function add_admin_scripts($hook) {	
		...
		wp_enqueue_script('maxbuttons-colorpicker-js', $this->plugin_url . 'js/colpick/colpick.js', array('jquery'), $version, true);
		//wp_enqueue_script('maxbuttons-lean', $this->plugin_url . 'js/leanModal/jquery.leanModal.min.js', array('jquery'), $version, true);
		wp_enqueue_script('maxbutton-admin', $this->plugin_url . 'js/maxbuttons-admin.js', array('jquery', 'jquery-ui-draggable', 'maxbuttons-tabs','maxbuttons-modal' ),$version, true); 
		wp_enqueue_script('maxbutton-js-init', $this->plugin_url . 'js/init.js', array('maxbutton-admin','maxcollections','maxbuttons-modal'),$version, true);
		wp_enqueue_script('maxbuttons-tabs', $this->plugin_url . 'js/maxtabs.js', array('jquery'),$version, true); 
		wp_enqueue_script('maxbuttons-modal', $this->plugin_url . 'js/maxmodal.js', array('jquery'), $version, true); 
