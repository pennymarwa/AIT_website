...
class maxAdmin 
{
	...
	?> 
			...
			<?php printf(__('Upgrade to MaxButtons Pro today! %sClick Here%s', 'maxbuttons'), '<a href="http://www.maxbuttons.com/pricing/?utm_source=mbf-dash' . $version . '&utm_medium=mbf-plugin&utm_content=click-here&utm_campaign=cart' . $version . '" target="_blank">', '</a>' ) ?>
			...
			<div class="twitter-follow">
				...
				<u></u><?php printf( __("%dK followers",'maxbuttons'), 8) ?></a></div>
