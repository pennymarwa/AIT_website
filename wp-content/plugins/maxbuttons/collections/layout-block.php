...
//			$basic = $this->collection->getBlock("basic");
	...
	<div class="inside"> 
		<div class="option"> 
			...
			<input type="number" class="tiny-nopad" id="margin_left" name="margin_left" value="<?php echo intval($margin_left) ?>" class="tiny"> <?php echo $px; ?>
		</div>
		...
		<div class="option"> 
			...
			<input type="number" name="item_margin_right" id="item_margin_right" value="<?php echo maxUtils::strip_px($item_margin_right) ?>"> <?php echo $px; ?>
		</div>
		
		<div class="option"> 
			<label for="item_margin_bottom"><?php _e("Item margin bottom","maxbuttons"); ?></label>
			<input type="number" name="item_margin_bottom" id="item_margin_bottom" value="<?php echo maxUtils::strip_px($item_margin_bottom) ?>"> 
				<?php echo $px ?> 
